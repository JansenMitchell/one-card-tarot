...
class OneCardTarot < Sinatra::Base
  before do
    @deck = [
      ...
      { name: 'The Tower', image: 'images/16.jpg', desc: 'Sudden changes without choice, collapse, escape from prison or bondages, accident. Plans will fall, intentions will break down. Finger of God. Bankruptcy. Sudden death.' },
